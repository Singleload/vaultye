...
export default function ActionDrawer({ action, isOpen, onClose }) {
  ...
  const handleSendToEasit = () => {
    // Simulera Easit-integration
    const payload = {
      destination: "Easit GO",
      actionId: action.id,
      title: action.title,
      ...
      originalPoint: {
        ...
        origin: action.point?.origin
      }
    };

    console.group("🚀 MOCK: Skickar till Easit...");
    console.log(JSON.stringify(payload, null, 2));
    console.groupEnd();

    alert("Simulering: Ärendet skickat till Easit! (Se konsolen för JSON)");
  };
        ...
        <>
          ...
          >
            ...
            <div className="p-6 border-t border-slate-100 bg-white flex justify-between items-center">
              ...
              >
                <Send size={18} /> Skicka till Easit
              </button>
