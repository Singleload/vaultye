            ...
            >
              ...
              <form onSubmit={handleCreateSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input required name="name" className="w-full p-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none" placeholder="t.ex. HR-Portalen" />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1 text-slate-700">Beskrivning</label>
                  <textarea name="description" rows="2" className="w-full p-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none" placeholder="Vad gör systemet?" />
                </div>
                ...
                <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input required name="ownerName" className="w-full p-2 border border-slate-300 rounded-lg text-sm" placeholder="Anna Andersson" />
                    </div>
                    <div>
                      <label className="block text-xs font-medium mb-1 text-slate-600">AD-användarnamn</label>
                      <input name="ownerUsername" className="w-full p-2 border border-slate-300 rounded-lg text-sm" placeholder="ann01and" />
                    </div>
                    <div className="col-span-2">
                      <label className="block text-xs font-medium mb-1 text-slate-600">Email</label>
                      <input required name="ownerEmail" className="w-full p-2 border border-slate-300 rounded-lg text-sm" placeholder="anna@foretag.se" />
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input required name="managerName" className="w-full p-2 border border-slate-300 rounded-lg text-sm" placeholder="Dennis Enström" />
                    </div>
                    <div>
                      <label className="block text-xs font-medium mb-1 text-slate-600">Ditt AD-användarnamn</label>
                      <input required name="managerUsername" className="w-full p-2 border border-slate-300 rounded-lg text-sm" placeholder="ens01den" />
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input name="resourceGroup" className="w-full p-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none" placeholder="t.ex. Styrgruppen" />
                </div>

                {/* KNAPPAR */}
                <div className="flex justify-end gap-3 pt-2">
                  <button type="button" onClick={() => setIsCreateModalOpen(false)} className="px-4 py-2 text-slate-600 font-medium hover:bg-slate-50 rounded-lg transition-colors">Avbryt</button>
                  <button type="submit" className="px-6 py-2 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 shadow-lg shadow-indigo-200 transition-all">Skapa System</button>
                </div>
              </form>
            </motion.div>
          </div>
